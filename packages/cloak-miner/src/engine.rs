...
mod tests {
    ...
    fn test_u256_lt() {
        // Simple comparison
        let a = [0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];

        let b = [0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
        ...
        let c = [0xFF; 32];
        let mut d = [0x00; 32];
        d[31] = 0x01; // Smallest bit in most significant byte
    ...
    fn test_mine_moderate_difficulty() {
        ...
        let solution = engine.mine().expect("Mining should succeed");
        assert!(solution.nonce > 0); // Should require some attempts
