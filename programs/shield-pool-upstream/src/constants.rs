...
pub const PROOF_LEN: usize = 260; // Groth16 proof length (with vkey hash)
pub const PUB_LEN: usize = 104; // Full public inputs length
pub const SP1_PUB_LEN: usize = 104; // SP1 Solana verifier expects 104-byte public inputs
...
// Seeds
pub static ROOTS_RING_SEED: &[u8] = b"roots_ring";
pub static NULLIFIER_SHARD_SEED: &[u8] = b"nullifier_shard";
